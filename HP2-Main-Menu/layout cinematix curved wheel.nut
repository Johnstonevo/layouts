...
local wheel_x = [ flx*0.90, flx*0.895, flx*0.856, flx*0.825, flx*0.80, flx*0.78, flx*0.77, flx*0.78, flx*0.80, flx*0.825, flx*0.856, flx*0.86, ]; 
...
local wheel_w = [ flw*0.18, flw*0.18, flw*0.18, flw*0.18, flw*0.18, flw*0.18, flw*0.18, flw*0.18, flw*0.18, flw*0.18, flw*0.18, flw*0.18, ];
local wheel_a = [  255,  255,  255,  255,  255,  255, 255,  255,  255,  255,  255,  255, ];
local wheel_h = [  flh*0.11,  flh*0.11,  flh*0.11,  flh*0.11,  flh*0.11,  flh*0.11, flh*0.11,  flh*0.11,  flh*0.11,  flh*0.11,  flh*0.11,  flh*0.11, ];
...
mfliter2 = fe.add_text( "Curved Wheel View", flx*0.007, fly*0.02, flx*0.3, flh*0.015 ),
}
