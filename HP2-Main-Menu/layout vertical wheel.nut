...
class UserConfig {
	...
	</ label="List Box and Wheel Background Opacity", help="Set List Box Opacity. 255 is equal to no opacity", options="100,200,255", order=24 /> ListBoxOpacity="";	
...
mfliter2 = fe.add_text( "Vertical Wheel View", flx*0.007, fly*0.02, flx*0.3, flh*0.015 ),
}
