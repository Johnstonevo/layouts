...
class UserConfig {
   ...
   </ label="Select cab skin", help="Select a cab skin image", options="default", order=2 /> enable_cab="default";
   ...
   </ label="Enable game info", help="Show game information", options="Yes,No", order=16 /> enable_ginfo="Yes";
   </ label="Enable text frame", help="Show text frame", options="yes,no", order=17 /> enable_frame="yes"; 
...
if ( my_config["enable_static"] == "yes" )
{
   ...
   local snapbg=null;
   snapbg = fe.add_image( "static.mp4", flx*0.236, fly*0.264, flw*0.351, flh*0.421);
...
surface_snap.set_pos(flx*0.236, fly*0.264, flw*0.351, flh*0.423);
...
{
local boxart = fe.add_artwork("boxart", flx*0.48, fly*0.7, flw*0.1, flh*0.2 );
}
...
{
local cartart = fe.add_artwork("cartart", flx*0.55, fly*0.75, flw*0.15, flh*0.15 );
}
