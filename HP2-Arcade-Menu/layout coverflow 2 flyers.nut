...
if ( my_config["hardware"] == "PC" ){
 local cList = MyGameList();
		...
		cList.artwork.type = "flyer"; 		// OPTIONS: name of the artwork to use for the conveyour
...
mfliter2 = fe.add_text( "Coverflow Flyer View", flx*0.007, fly*0.04, flx*0.3, flh*0.015 ),
}
