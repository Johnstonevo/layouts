...
class UserConfig {
	...
	</ label="Wheel Layout", help="Select wheel type", options="List Box,Horizontal,Horizontal Animated,Vertical Wheel", order=19 /> enable_list_typeCinematix="List Box";
	...
	</ label="List Box Opacity", help="Set List Box Opacity. 255 is equal to no opacity", options="100,200,255", order=24 /> ListBoxOpacity="255";	
...
function on_transition( ttype, var, ttime ) {
	...
	if ( my_config["enable_list_typeCinematix"] == "List Box" ){
			gameListBoxAnimX.to = (flw + flx - crw - lbw)*1.04
...
mfliter2 = fe.add_text( "Full Screen Listbox View", flx*0.007, fly*0.04, flx*0.3, flh*0.015 ),
}
